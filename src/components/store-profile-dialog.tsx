...
export function StoreProfileDialog() {
  ...
  // Usando o values para que o modal já esteja com os dados preenchidos, com defaultValues o modal ficaria vazio pois ainda não teríamos os dados do restaurante
  const {
    register,
    handleSubmit,
